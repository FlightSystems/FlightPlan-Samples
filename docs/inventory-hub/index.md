...
>
> Total: 6 (High: 1, Medium: 3, Low: 2, Info: 0).
...
- [Medium] ([architecture-overview](architecture-overview.md#service-overview)) Services missing platform assignment: 1 service(s) do not declare a platform. This reduces clarity on runtime foundations and operational responsibilities.
...
- [Medium] ([security-overview](security-overview.md#trust-boundary-analysis)) Trust boundary crossings: 8 interaction(s) cross zone boundaries. Review identity propagation, encryption in transit, and authorization between zones.
- [Low] ([architecture-overview](architecture-overview.md#service-overview)) Services missing repo URL: 5 service(s) do not declare a repoUrl. Adding repo links improves traceability for ownership, releases, and incident response.
- [Low] ([service-catalog](service-catalog/index.md#service-catalog)) Services missing repo URL: 5 service(s) do not declare a repoUrl.
